// ============================================================
// Shackle Protector — Reference (26mm C-Channel) Variant
...
c_channel_radius = 13;    // mm — C-channel outer radius (reference size)
wall_thickness   = 5.3;   // mm — C-channel wall (reference size)
